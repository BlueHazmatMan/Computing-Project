 ...
 * @author edwar
 */
public class ViewParty extends javax.swing.JFrame {

    /**
     * Creates new form ViewParty
     */
    public ViewParty() {
        initComponents();
    ...
    private ArrayList<String> getPlayerList(){
        ...
        playerList = tpi.getPlayerList();
        return playerList;
    }
    
    private void displayPlayerList(ArrayList<String> playerList){
        DatabaseInteractions dbi = new DatabaseInteractions();
        for (int i = 0; i < playerList.size(); i++) {
            players.append(playerList.get(i)+", level "+dbi.getPlayerLevel(playerList.get(i))+" "+dbi.getPlayerClass(playerList.get(i))+"\n");
        }
    }
